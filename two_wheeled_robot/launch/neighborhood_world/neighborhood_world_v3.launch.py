...
#              The robot must be in URDF format.
...
def generate_launch_description():
  ...
  # Define constants for paths to files and folders
  package_name = 'two_wheeled_robot'
  robot_name_in_model = 'two_wheeled_robot'
  default_launch_dir = 'launch'
  gazebo_models_path = 'models'
  map_file_path = 'maps/neighborhood_world/neighborhood_world.yaml'
  nav2_params_path = 'params/neighborhood_world/nav2_params_urdf.yaml'
  robot_localization_file_path = 'config/ekf_urdf.yaml'
  rviz_config_file_path = 'rviz/neighborhood_world/nav2_config_urdf.rviz'
