...
#              The spawning of the robot must be indicated inside the world file.
#              The robot must exist in both SDF and URDF format.
...
def generate_launch_description():
  ...
  nav2_params_path = 'params/neighborhood_world/nav2_params.yaml'
  robot_localization_file_path = 'config/ekf.yaml'
  rviz_config_file_path = 'rviz/neighborhood_world/nav2_config.rviz'
